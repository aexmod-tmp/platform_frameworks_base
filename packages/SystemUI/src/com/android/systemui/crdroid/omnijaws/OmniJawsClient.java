...
*
*/
package com.android.systemui.crdroid.omnijaws;
...
public class OmniJawsClient {
    ...
    public static class WeatherInfo {
        ...
        public String toString() {
            return city + ":" + new Date(timeStamp) + ": " + windSpeed + ":" + windDirection + ":" +conditionCode + ":" + temp + ":" + humidity + ":" + condition + ":" + tempUnits + ":" + windUnits + ": " + forecasts + ": " + pinWheel;
        }
    ...
    public void updateIconPack() {
        mSettingIconPackage = Settings.System.getStringForUser(mContext.getContentResolver(),
