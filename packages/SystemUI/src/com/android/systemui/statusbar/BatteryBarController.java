...
public class BatteryBarController extends LinearLayout {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(
                    ...
                    false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUSBAR_BATTERY_BAR_SHOW_ON_LOCK_SCREEN), false, this);
        }
    ...
    public void updateSettings() {
        ...
        int locationLockScreen = Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.STATUSBAR_BATTERY_BAR_SHOW_ON_LOCK_SCREEN, 0);

        if (mLocation > 0 && (isLocationValid(mLocation) || isLocationValid(locationLockScreen))) {
            removeBars();
            addBars();
