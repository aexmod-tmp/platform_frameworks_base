...
import com.android.internal.util.lineageos.ColorUtils;

import static com.github.aexmod.livedisplay.LiveDisplayManager.MODE_AUTO;
import static com.github.aexmod.livedisplay.LiveDisplayManager.MODE_DAY;
import static com.github.aexmod.livedisplay.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mDefaultDayTemperature = mContext.getResources().getInteger(
                R.integer.config_dayColorTemperature);
        mDefaultNightTemperature = mContext.getResources().getInteger(
                R.integer.config_nightColorTemperature);

        mColorTemperatureRange = Range.create(
                mContext.getResources().getInteger(
                        R.integer.config_minColorTemperature),
                mContext.getResources().getInteger(
                        R.integer.config_maxColorTemperature));

        mColorBalanceCurve = com.android.internal.util.lineageos.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.lineageos.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
