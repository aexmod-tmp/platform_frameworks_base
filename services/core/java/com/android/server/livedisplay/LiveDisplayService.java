...
import com.github.aexmod.livedisplay.ILiveDisplayService;
import com.github.aexmod.livedisplay.LiveDisplayConfig;
import android.provider.Settings;

import static com.github.aexmod.livedisplay.LiveDisplayManager.FEATURE_MANAGED_OUTDOOR_MODE;
import static com.github.aexmod.livedisplay.LiveDisplayManager.MODE_DAY;
...
public class LiveDisplayService extends SystemService {
    ...
    public void onStart() {
        Log.e(TAG, "onStart");
        publishBinderService(ContextConstants.LINEAGE_LIVEDISPLAY_SERVICE, mBinder);
    }

    @Override
    public void onBootPhase(int phase) {
        Log.e(TAG, "onBootPhase");
        if (phase == PHASE_BOOT_COMPLETED) {
            Log.e(TAG, "onBootPhase PHASE_BOOT_COMPLETED");
            ...
            int defaultMode = mContext.getResources().getInteger(
                    R.integer.config_defaultLiveDisplayMode);
    ...
    private final IBinder mBinder = new ILiveDisplayService.Stub() {
        ...
        public LiveDisplayConfig getConfig() {
            Log.e(TAG, "IBinder getConfig");
            return mConfig;
        }

        @Override
        public int getMode() {
            Log.e(TAG, "IBinder getMode");
            if (mConfig.hasModeSupport()) {
        ...
        public boolean setMode(int mode) {
            Log.e(TAG, "IBinder setMode");
            mContext.enforceCallingOrSelfPermission(
                    Manifest.permission.MANAGE_LIVEDISPLAY, null);
            if (!mConfig.hasModeSupport()) {
                return false;
            }
        ...
        public int getColorTemperature() {
            Log.e(TAG, "IBinder getColorTemperature");
    ...
    private final DisplayManager.DisplayListener mDisplayListener =
        ...
        public void onDisplayChanged(int displayId) {
            Log.e(TAG, "mDisplayListener onDisplayChanged "+displayId);
    ...
    private PowerManagerInternal.LowPowerModeListener mLowPowerModeListener =
        ...
        public void onLowPowerModeChanged(PowerSaveState state) {
            Log.e(TAG, "mLowPowerModeListener onLowPowerModeChanged");
         ...
         public int getServiceType() {
            Log.e(TAG, "mLowPowerModeListener getServiceType");
             return SERVICE_TYPE_DUMMY;
         }
    };

    // Watch for mode changes
    private final class ModeObserver extends ContentObserver {
        ...
        ModeObserver(Handler handler) {
            super(handler);
Log.e(TAG, "ModeObserver constructor");
        ...
        public void onChange(boolean selfChange, Uri uri) {
            Log.e(TAG, "ModeObserver onChange");
            int mode = getMode();
    ...
    private final TwilightListener mTwilightListener = new TwilightListener() {
        ...
        public void onTwilightStateChanged(TwilightState state) {
            Log.e(TAG, "mTwilightListener onTwilightStateChanged");
        ...
        if (counter == 0) {
            ...
            Notification.Builder builder = new Notification.Builder(mContext)
                    .setContentTitle(mContext.getResources().getString(
                            R.string.live_display_title))
                    .setContentText(mContext.getResources().getString(
                            R.string.live_display_hint))
                    .setSmallIcon(R.drawable.ic_livedisplay_notif)
